<?php
	...
	$year =  date("Y");
	$damaged = new Model;
	$_SESSION['current_page'] = "lost_books.php";
	
	$sql = "SELECT * FROM tbl_books JOIN tbl_copy ON tbl_books.book_id=tbl_copy.book_id JOIN tbl_borrowed ON tbl_copy.account_no=tbl_borrowed.account_no WHERE tbl_copy.status='Lost' AND tbl_borrowed.status='Lost' ORDER BY tbl_copy.book_id, tbl_copy.copy";
	$data_damaged = $damaged->displayRecord($sql);
	$total_lost = count($data_damaged);
				...
				<div class="" role="main" style="">
					...
					<div class="col-md-12 col-sm-12 col-xs-12" role="tabpanel" data-example-id="togglable-tabs"  >
						<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
						  <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true"><span class="badge bg-blue "><i class="fa fa-table"></i></span>   Lost</a>
						  </li>
						  ...
						  <div role="tabpanel" class="tab-pane fade active in"  id="tab_content1" aria-labelledby="home-tab">
							<div class="x_panel">
							  <div class="x_title">
								...
								<h3 style="margin-left:60px; margin-top:-35px">Lost books</h3>
								  <div class="btn-group pull-right" style="margin-top:-38px">
									   <button type="button" class="btn btn-primary" onclick="printTable()">
										 <i class="fa fa-print"></i> Print</button>
									  <a type="button" download="Listoflostbooks.xls" onclick="return ExcellentExport.excel(this, 'table2', 'Listoflostbooks');" class="btn btn-primary"><i class="fa fa-file-excel-o"></i> Excel</a>
									</div>
							  ...
							  <div class="x_content">
								  ...
								  <div class="col-md-12 col-sm-12 col-xs-12">
										 <center><h3 id="title_name">LIST OF LOST BOOKS</h3></center>
										  <br>
											...
											if($count == $end) {
												...
												if($count == 100) {
													...
													<div class="box-footer" style="border-top: 1px solid #afaaaa;">
														<p>Showing '.$count.' of '.$total_lost.' entries</p>
									  ...
									  <table class="table table-bordered table-striped jambo_table hide" id="table2">
											<tr>
												 <td colspan="9"><p style="font-size:20px">LIST OF LOST BOOKS</p></td>
											  </tr>
											<tr>
												<th>No</th>
											  <th width="10%">Acc. No</th>
												  ...
												  <table class="table table-bordered  jambo_table">
													  ...
													  <tbody>
														  <tr>
															  ...
															  <td>
																  <center>
																	  <form action="monthly_lost.php" method="post">
