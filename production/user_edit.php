<?php
	...
	$_SESSION['userupdate_token'] = $token;
	...
	if(isset($_GET['user_id']) && !empty($_GET['user_id']) && isset($_GET['user_token']) && isset($_SESSION['user_token'])) {
		...
		if($_SESSION['user_token'] == $_GET['user_token']) {
			...
			$_SESSION['current_page'] = "user_edit.php";
		}
		else {
						...
						<div class="x_panel">
						  <div class="x_title">
							<img src="images/user_edit.png" width="50px" height="50px">
								<h3 style="margin-left:60px; margin-top:-38px">Update user data</h3>
								  <div class=" btn-group pull-right" style="margin-left:60px; margin-top:-45px">
									  <a href="user_view.php? user_id=<?php echo $user_id;?> & user_token=<?php echo $pass_token;?>" class="btn btn-primary btn-sm"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit User Details"><i class="fa fa-user"></i> View</a>
						  ...
						  <div class="x_content">
							...
							<div class="col-xs-3">
							  ...
							  <ul class="nav nav-tabs tabs-left">
								<li class="active"><a href="#details" data-toggle="tab"><i class="glyphicon glyphicon-info-sign" ></i> User Details</a>
								</li>
								<li><a href="#transaction" data-toggle="tab"><i class="fa fa-exchange" ></i> User Account</a>
								</li>
							  </ul>
							</div>
								  ...
								  <p class="lead">User Details</p>
									...
									<form id="userEdit">
											...
											<div class="col-md-10 col-sm-10 col-xs-12 form-group">
												<input type="text" class="form-control has-feedback-left" name="employee_no" id="employee_no" onkeyup="validation('employee_no')" onkeydown="validation('employee_no')" onmouseout="validation('employee_no')" placeholder="Employee No" value="<?php echo $data2[0]['user_id']; ?>" required="" />
												<input type="hidden" name="action" value="update"/>
												<input type="hidden" name="userupdate_token" value="<?php echo $token; ?>"/>
											...
											<div class="col-md-10 col-sm-10 col-xs-12 form-group">
												<input list="list_fn" class="form-control has-feedback-left" name="firstname" id="firstname" onkeyup="validation('firstname')" onkeydown="validation('firstname')" onmouseout="validation('firstname')" placeholder="First Name" value="<?php echo $data2[0]['firstname']; ?>" required="" style="background-color:#e2e2e2; text-transform:capitalize" />
											...
											<div class="col-md-10 col-sm-10 col-xs-12 form-group">
												<input list="list_ln" class="form-control has-feedback-left" name="lastname" id="lastname" onkeyup="validation('lastname')" onkeydown="validation('lastname')" onmouseout="validation('lastname')" placeholder="Last Name" value="<?php echo $data2[0]['lastname']; ?>" required=""  style="background-color:#e2e2e2; text-transform:capitalize"/>
												<span class="fa fa-user form-control-feedback left" aria-hidden="true" style="color:black"></span>
											...
											<div class="col-md-10 col-sm-10 col-xs-12 form-group">
												<input list="list_position" class="form-control has-feedback-left" name="position" id="position" onkeyup="validation('position')" onkeydown="validation('position')" onmouseout="validation('position')" value="<?php echo $data2[0]['position']; ?>" placeholder="Position"  style="background-color:#e2e2e2; text-transform:capitalize" required="" />
											...
											<div class="col-md-10 col-sm-10 col-xs-12 form-group">
												 <textarea rows="2" required="required" class="form-control" name="address" id="address" onkeyup="validation('address')" onkeydown="validation('address')" onmouseout="validation('address')" style="background-color:#e2e2e2; text-transform:capitalize"  placeholder="Address"><?php echo $data2[0]['address']; ?></textarea>
											</div>
											<label class="col-md-10 col-sm-10 col-xs-12 form-group"> Contact No: </label>
											<div class="col-md-10 col-sm-10 col-xs-12 form-group">
												<input type="text" class="form-control has-feedback-left" name="contactno" id="contactno" onkeyup="validation_two('contactno')" onkeydown="validation_two('contactno')" onmouseout="validation_two('contactno')" value="<?php echo $data2[0]['contactno']; ?>" placeholder="Contact Number" required="" />
									...
									<form id="accountEdit">
											<div class="col-md-10 col-sm-10 col-xs-12 form-group photos">
												...
												<div class="col-md-7 col-sm-12 col-xs-12">
													<center>
														<img class="pre_img" src="<?php echo 'images_uploaded/'.$data2[0]['image']; ?>" style="width: 170px; height:150px; max-height: 100px;">
											...
											<div class="col-md-10 col-sm-10 col-xs-12 form-group">
												<input type="hidden" name="action" value="updateA">
												<input type="hidden" name="userupdate_token" value="<?php echo $token; ?>"/>
												<input type="hidden" name="user_id" value="<?php echo $data2[0]['user_id']; ?>">
												<input type="text" class="form-control has-feedback-left" name="username" id="username" onkeyup="validation('username')" onkeydown="validation('username')" onmouseout="validation('username')" placeholder="Username" value="<?php echo $data2[0]['username']; ?>" required="" />
											...
											<div class="col-md-10 col-sm-10 col-xs-12 form-group">
												<input type="email" class="form-control has-feedback-left" name="email" placeholder="Email" value="<?php echo $data2[0]['email']; ?>" required="" style="background-color:#e2e2e2" />
												<span class="fa fa-envelope form-control-feedback left" aria-hidden="true" style="color:black"></span>
											</div>
											<label class="col-md-10 col-sm-10 col-xs-12 form-group"> Status: </label>
											<div class="col-md-10 col-sm-10 col-xs-12 form-group">
